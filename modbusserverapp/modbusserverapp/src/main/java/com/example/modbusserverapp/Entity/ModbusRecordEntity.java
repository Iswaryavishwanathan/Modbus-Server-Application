package com.example.modbusserverapp.Entity;
...
public class ModbusRecordEntity {
    ...
    // Constructor to accept timestamp, name, set weight, and actual weight
    public ModbusRecordEntity(LocalDateTime timestamp, String name, int setWeight, int actualWeight) {
